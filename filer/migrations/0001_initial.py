    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(
                    related_name='filer_owned_folders', verbose_name='owner', blank=True,
                    to=settings.AUTH_USER_MODEL, null=True, on_delete=django.db.models.deletion.SET_NULL)),
                ('parent', models.ForeignKey(
                    related_name='children', verbose_name='parent', blank=True, to='filer.Folder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='folder', blank=True, to='filer.Folder', null=True)),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, related_name='filer_folder_permissions', verbose_name='group', blank=True, to='auth.Group', null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, related_name='filer_folder_permissions', verbose_name='user', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL,
                                    related_name='all_files', verbose_name='folder',
                                    blank=True, to='filer.Folder', null=True),
        ...
        migrations.AddField(
            ...
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL,
                                    related_name='owned_files', verbose_name='owner',
        ...
        migrations.AddField(
            ...
            name='file',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, verbose_name='file', to='filer.File'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('file_ptr', models.OneToOneField(
                    on_delete=django.db.models.deletion.CASCADE,
                    serialize=False, auto_created=True, to='filer.File',
